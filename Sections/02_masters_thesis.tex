...
\begin{frame}{Translation: At Most Two Coexisting Cycles}
	...
	\begin{tikzpicture}[thick,scale=1, every node/.style={font=\huge}]
		...
		\only<6>{
			\node[scale=0.4] (phi) at (bl) {$t\left(\sigma_{1}\sigma_{2}\right) \ldots t\left(\sigma_{n}\sigma_{1}\right)  \ldots t\left(\sigma_{n-1}\sigma_{n}\right)$};
			\node[scale=0.4] (s4phi) at (br) {$t\left(\sigma_{3}\sigma_{4}\right) \ldots t\left(\right) \ldots t\left(\sigma_{n-1}\sigma_{n}\right)t\left(\sigma_{1}\sigma_{2}\right)$};
		}
		\only<7>{
		\node[scale=0.6] (phi) at (bl) {$\phi_{1} \ldots \phi_{\frac{n}{2}-1} t\left(\sigma_{n}\sigma_{1}\right) \phi'_{1}  \ldots \phi'_{n}$};
		\node[scale=0.6] (s4phi) at (br) {$\phi_{1} \ldots t\left(\right) \ldots t\left(\sigma_{n-1}\sigma_{n}\right)t\left(\sigma_{1}\sigma_{2}\right)$};
		}
		\only<5-7>{
...
\begin{frame}{Translation: No Coexistence when Number of 2-Syllables Odd}
	...
	\begin{tikzpicture}[thick,scale=1, every node/.style={font=\huge}]
		...
		\only<2-6>{
			\node (sigma) at (al) {$\sigma_{1}\sigma_{2}\ldots\sigma_{2n+1}$};
			\node (s2sigma) at (ar) {$\sigma_{2}\ldots\sigma_{2k+1}\sigma_{1}$};
		}
		\only<3>{
			\node[scale=0.4] (phia) at (bl) {$t\left(\sigma_{1}\sigma_{2}\right) \ldots t\left(\sigma_{2n+1}\sigma_{1}\right) t\left(\sigma_{2}\sigma_{3}\right) \ldots t\left(\sigma_{2n}\sigma_{2n+1}\right)$};
			\node[scale=0.4] (phib) at (br) {$t\left(\sigma_{2}\sigma_{3}\right) \ldots t\left(\sigma_{2n}\sigma_{2n+1}\right) t\left(\sigma_{1}\sigma_{2}\right) \ldots t\left(\sigma_{2n+1}\sigma_{1}\right)$};
		}
		\only<4-6>{
		\node[scale=0.6] (phia) at (bl) {$\phi_{1} \ldots \phi_{n} t(\sigma_{2n+1}\sigma_{1}) \phi'_{1} \ldots \phi'_{n}$};
		\node[scale=0.6] (phib) at (br) {$\phi'_{1} \ldots \phi'_{n} \phi_{1} \ldots \phi_{n} t(\sigma_{2n+1}\sigma_{1})$};
		}
		\only<5>{
			\draw[->] (phia) -- (phib) node[midway,above=0.2em,scale=0.5] {$s_{4}^{n+1}$};
		}
		\only<6>{
